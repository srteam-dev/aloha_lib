...
export interface NavbarProps extends React.HTMLAttributes<HTMLElement> {
    ...
    /** Text color */
    textColor?: ColorName;
    /** Active item indicator color (background behind icon) */
    activeColor?: ColorName;
    /** Active item icon color (onlogin only) */
    activeIconColor?: ColorName;
                            ...
                            >
                                ...
                                >
                                    <Icon
                                        ...
                                        size="sm"
                                        color={item.active
                                            ? ((activeIconColor ?? 'ice') as ColorOption)
                                            : (textColor as ColorOption)
                                        }
                                    />
                                </div>
